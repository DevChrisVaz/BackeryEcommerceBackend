...
class DeleteToppingType {
    ...
    run(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (foundToppingType) {
                const deletedToppingType = yield this.toppingTypeRepo.delete(foundToppingType);
                if (deletedToppingType)
                    return deletedToppingType;
            }
            throw new ToppingTypeNotFoundError_1.default();
        });
    }
}
exports.default = DeleteToppingType;
